...
<div class="content-wrapper">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-warning box-solid">
     ...
     <h3 class="box-title">Bienvenido a la Lista de Usuarios</h3>
     </div>
     </div>
...
<table  id="table" class="table  table-bordered .table-striped thead-dark" style="width:100%">
  ...
  /*se realiza la consulta sql,en donde seleccionamos  los campos de usuario */
  ...
  <a href="editar.php?id=<?php echo $data['idusuario']; ?>"  class="btn btn-success">Editar<i class='fas fa-edit'></i></a>
  <form action="eliminar_usuario.php?id=<?php echo $data['idusuario']; ?>" method="post" class="confirmar d-inline">
  <button class="btn btn-danger"  onclick="location.refresh()" type="submit"><i class='fas fa-trash'></i> </button>
  </form>
